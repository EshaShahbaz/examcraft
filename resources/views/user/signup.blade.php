      ...
      @endif
       <form action="{{$url}}" method="post">
        ...
        <div class="form-group">
             ...
             <input type="text"  class="form-control" name="name" placeholder="Enter your name"  value="{{ old('name', $user->name) }}">
           ...
           <div class="form-group">
              ...
              <input type="email"  class="form-control" name="email" placeholder="Enter your Email" value="{{ old('email', $user->email) }}">
              <span class="text-danger">
                @error('email')
                  {{$message}}
                @enderror
            ...
            <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="Enter your Name" value="{{ old('password', $user->password) }}">
                  <span class="text-danger">
                    @error('password')
                      {{$message}}
                    @enderror
           ...
           <select name="role" id="role"  class="dropdown-content">
